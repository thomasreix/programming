...
class Chunk:
    def __init__(self, world, chunk_position):
        ...
        self.blocks = [
            [[0 for z in range(CHUNK_LENGTH)] for y in range(CHUNK_HEIGHT)]
    ...
    def update_mesh(self):
        ...
        for subchunk_position in self.subchunks:
            ...
            mesh_indices = [
                index + self.mesh_index_counter for index in subchunk.mesh_indices
            ]
    ...
    def draw(self):
        ...
        gl.glDrawElements(
            gl.GL_TRIANGLES, self.mesh_indices_length, gl.GL_UNSIGNED_INT, None
        )
