// C tutorial for beginners full course by Bro Code
// https://www.youtube.com/watch?v=87SH2Cn0s9A&t=6511s
...
int main() {
    ...
    */
    ...
    int compare_n = strncmp(
        stringA, stringB, n); // strcmp(str1, str2, n) --> compares n characters
    if (compare_n == 0) {
